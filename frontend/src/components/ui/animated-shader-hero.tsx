...
// Reusable Hero Component with Stats
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center mt-8 animate-fade-in-up animation-delay-800">
              {buttons.primary && (
                <button 
                  ...
                  className="px-6 py-2.5 bg-gradient-to-r from-orange-500 to-yellow-500 hover:from-orange-600 hover:to-yellow-600 text-black rounded-full font-semibold text-base transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-orange-500/25"
                >
              ...
              {buttons.secondary && (
                <button 
                  ...
                  className="px-6 py-2.5 bg-orange-500/10 hover:bg-orange-500/20 border border-orange-300/30 hover:border-orange-300/50 text-orange-100 rounded-full font-semibold text-base transition-all duration-300 hover:scale-105 backdrop-blur-sm"
                >
          ...
          {showStats && (
            <div className="flex flex-wrap gap-6 md:gap-8 justify-center mt-6 md:mt-8 animate-fade-in-up animation-delay-1000">
              <div className="text-center">
                <div className="text-base sm:text-lg md:text-xl font-bold text-warm-white">75K+</div>
                <div className="text-[10px] sm:text-xs text-warm-white/60">Users Trust Us</div>
              </div>
              <div className="text-center">
                <div className="text-base sm:text-lg md:text-xl font-bold text-warm-white">82%</div>
                <div className="text-[10px] sm:text-xs text-warm-white/60">Feel Calmer</div>
              </div>
              <div className="text-center">
                <div className="text-base sm:text-lg md:text-xl font-bold text-warm-white">5M</div>
                <div className="text-[10px] sm:text-xs text-warm-white/60">Conversations</div>
              </div>
              <div className="text-center">
                <div className="text-base sm:text-lg md:text-xl font-bold text-warm-white">24/7</div>
                <div className="text-[10px] sm:text-xs text-warm-white/60">Available Support</div>
              </div>
            </div>
          )}
        </div>
